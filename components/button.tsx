...
const deleteImageWithId = async (formData: FormData): Promise<void> => {
    const response = await deleteImage(id); // Appelle votre fonction d'origine
    if (response?.message) {
      console.log(response.message,formData); // Log ou toute autre action à faire
    }
  };
